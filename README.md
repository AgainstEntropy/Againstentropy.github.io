...
- [al-folio](#al-folio-1)
  ...
  - [Getting started](#getting-started-1)
    - [Installation](#installation-1)
      - [Local setup using Docker (Recommended on Windows)](#local-setup-using-docker-recommended-on-windows-1)
      - [Local Setup (Standard)](#local-setup-standard-1)
  ...
  - [Features](#features-1)
    ...
    - [Layouts](#layouts-1)
      - [The iconic style of Distill](#the-iconic-style-of-distill-1)
      - [Full support for math \& code](#full-support-for-math--code-1)
      - [Photos](#photos-1)
    - [Other features](#other-features-1)
      - [GitHub repositories and user stats](#github-repositories-and-user-stats-1)
      - [Theming](#theming-1)
      - [Social media previews](#social-media-previews-1)
      - [Atom (RSS-like) Feed](#atom-rss-like-feed-1)
